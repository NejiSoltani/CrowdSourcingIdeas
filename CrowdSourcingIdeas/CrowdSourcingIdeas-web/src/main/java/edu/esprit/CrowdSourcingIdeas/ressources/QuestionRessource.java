...
public class QuestionRessource {
	...
	public Response AfficherQuiz()
	{
		return Response.ok(metier.afficherQuiz()).build();
	}
	
	
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response getQuestions(Quiz q)
	{
		return Response.ok(metier.findQuestions(q)).build();
	}
